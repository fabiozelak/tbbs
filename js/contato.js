 ...
 <div class=" container-fluid divisor"></div>
        ...
        <div class="row">
            <div class="col-lg-4 text-center">
                <h5 class="text-center py-4">WhatsApp</h5>
            ...
            <div class="col-lg-4 text-center">
                <h5 class="text-center py-4">Telefone</h5>
                <div class="col">                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                ...
                <div class="col">(41)3092-6186</div>
            </div>
            <div class="col-lg-4 text-center">
