...
const lista = [
    ...
    {nome:"Alta Frequência",            facial:"y",hidden:"n",link:"alta_frequencia",descricao:"Melhore a circulação e promova a renovação celular com nosso tratamento, ideal para uma pele mais saudável e vibrante.",thumb:"images/altafrequencia.webp", ordem:3},
    {nome:"Drenagem Detox",             facial:"n",hidden:"n",link:"drenagem_detox",descricao:"Desintoxique seu corpo e reduza o inchaço com nossa drenagem linfática detox, promovendo bem-estar e leveza.",thumb:"images/drenagem.jpg", ordem:4},
    ...
    {nome:"Ultrasson",                  facial:"n",hidden:"n",link:"ultrasson",descricao:"",thumb:"images/ultrassom.jpg", ordem:7},
